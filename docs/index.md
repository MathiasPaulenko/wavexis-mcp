...
**195 tools** across **13 capability tiers**. 100% Python, no Node.js, no Chromium download — uses your existing Chrome/Edge.
...
- **195 tools** — the most comprehensive browser automation MCP server
...
- [Tools reference](tools/core.md) — all 195 tools documented by tier
