...
**156 tools** across **13 capability tiers**. 100% Python, no Node.js, no Chromium download — uses your existing Chrome/Edge.

## Key features

- **Zero install** — uses your local Chrome/Edge, no 200MB Chromium download (~5MB package)
- **156 tools** — the most comprehensive browser automation MCP
